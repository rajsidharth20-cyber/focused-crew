  ...
  return (
    <div className="fixed inset-0 z-50 bg-background/80 backdrop-blur-sm flex items-center justify-center px-4">
      <div className="glass-card glow-amber p-8 w-full max-w-sm">
        ...
        <h2 className="font-display text-lg font-bold text-foreground text-center mb-1">What's your name?</h2>
        <p className="text-xs text-muted-foreground text-center mb-5">We'll use this to greet you each day.</p>
